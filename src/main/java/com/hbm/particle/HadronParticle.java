...
public class HadronParticle extends ParticleNT {
    ...
    /** Vorfaktor der Groesse; makeSmall setzt ihn herab. */
    ...
    /** Halb so gross und halb so lange sichtbar. */
    public HadronParticle makeSmall(boolean small) {
    ...
    public void render(VertexConsumer consumer, Camera camera, float partialTicks) {
        ...
        this.quadSize = (this.age + partialTicks) * 0.15F * this.scale;
