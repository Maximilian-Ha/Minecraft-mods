...
public class AnvilRecipes {
    ...
    private static void registerConstruction() {
        // Der Waechter MUSS ganz vorne stehen, so wie in registerSmithing(). Stand er hinter dem
        // ersten Rezept, war er beim ersten Aufruf bereits wahr und die Methode kehrte sofort
        // zurueck -- alle 74 folgenden Amboss-Rezepte waren damit toter Code und nie im Spiel.
        if(!CONSTRUCTION_RECIPES.isEmpty()) {
            return;
        }

        // Originalrezept aus 1.7.10, Stufe 2. Das grosse Zahnrad kam in Runde 9 dazu; bis dahin
        // war es hier ersatzlos gestrichen. Original: gear_large mit Metadaten 0, also Eisen.
        CONSTRUCTION_RECIPES.add(new AnvilConstructionRecipe(
                new AStack[] {
                        new RecipesCommon.TagStack(ItemTags.PLANKS, 16),
                        new ComparableStack(NtmItems.PLATE_STEEL.get(), 6),
                        new ComparableStack(NtmItems.INGOT_COPPER.get(), 8),
                        new ComparableStack(NtmItems.COIL_COPPER.get(), 4),
                        new ComparableStack(NtmItems.GEAR_LARGE.get(), 1, GearItem.GearType.IRON.ordinal())
                },
                new AnvilOutput(new ItemStack(NtmBlocks.MACHINE_STIRLING.asItem()))
        ).setTier(2).setOverlay(OverlayType.CONSTRUCTION));

        /*
         * Der Annihilator, Runde 128. Im Original steht er ebenfalls am Amboss der zweiten
         * Stufe -- er ist keine Werktischmaschine.
         */
        CONSTRUCTION_RECIPES.add(new AnvilConstructionRecipe(
                new AStack[] {
                ...
                new AnvilOutput(new ItemStack(NtmBlocks.MACHINE_ANNIHILATOR.asItem()))
        ).setTier(2).setOverlay(OverlayType.CONSTRUCTION));
        ...
        /*
         * Runde 105: die beiden Wasserpumpen. Muster aus AnvilRecipes.java Z. 245-261.
         *
         * ABWEICHUNG: das Original nimmt Bleirohre; der Port hat sie, aber als einfachen
         * Gegenstand statt als OreDict-Gruppe -- die Mengen sind unveraendert.
         *
         * ABWEICHUNG: die Dampfpumpe braucht im Original sechzehn Bretter beliebiger Art. Hier
         * steht die Eiche; eine Tag-Zutat waere moeglich, aber der Port fuehrt seine
         * Ambossrezepte durchweg mit festen Gegenstaenden.
         */
        CONSTRUCTION_RECIPES.add(new AnvilConstructionRecipe(
                new AStack[] {
                        new ComparableStack(Blocks.COBBLESTONE, 8),
                        new ComparableStack(Blocks.OAK_PLANKS, 16),
                        new ComparableStack(NtmItems.PLATE_COPPER.get(), 8),
                        new ComparableStack(NtmItems.PIPE_LEAD.get(), 2)
                },
                new AnvilOutput(new ItemStack(NtmBlocks.PUMP_STEAM.asItem()))
        ).setTier(2).setOverlay(OverlayType.CONSTRUCTION));
        ...
        CONSTRUCTION_RECIPES.add(new AnvilConstructionRecipe(
                new AStack[] {
                        ...
                        new ComparableStack(NtmItems.PIPE_LEAD.get(), 4),
                        new ComparableStack(NtmItems.MOTOR.get(), 2),
                        new ComparableStack(NtmItems.CIRCUIT_VACUUM_TUBE.get(), 4)
                },
                new AnvilOutput(new ItemStack(NtmBlocks.PUMP_ELECTRIC.asItem()))
        ...
        // Runde 10: Aschegrube und die beiden Schornsteine, Stufen wie im Original (2/2/3).
        // ANY_CONCRETE.any() -> Tag ntm:any_concrete, in Runde 8 eingefuehrt.
        CONSTRUCTION_RECIPES.add(new AnvilConstructionRecipe(
                new AStack[] {
                ...
                new AnvilOutput(new ItemStack(NtmBlocks.MACHINE_ASHPIT.asItem()))
        ).setTier(2).setOverlay(OverlayType.CONSTRUCTION));
        ...
        CONSTRUCTION_RECIPES.add(new AnvilConstructionRecipe(
                new AStack[] {
                        ...
                        new ComparableStack(NtmBlocks.STEEL_GRATE.get(), 2)
                },
                new AnvilOutput(new ItemStack(NtmBlocks.CHIMNEY_BRICK.asItem()))
        ).setTier(2).setOverlay(OverlayType.CONSTRUCTION));

        CONSTRUCTION_RECIPES.add(new AnvilConstructionRecipe(
                new AStack[] {
                        new ComparableStack(NtmItems.PLATE_STEEL.get(), 16),
                        new RecipesCommon.TagStack(ItemTags.create(ResourceLocation.fromNamespaceAndPath("ntm", "any_concrete")), 64),
                        new ComparableStack(NtmBlocks.STEEL_GRATE.get(), 4),
                        new ComparableStack(NtmItems.FILTER_COAL.get(), 4)
                },
                new AnvilOutput(new ItemStack(NtmBlocks.CHIMNEY_INDUSTRIAL.asItem()))
        ).setTier(3).setOverlay(OverlayType.CONSTRUCTION));

        /* Runde 119: die Autosaege, Stufe 2 wie im Original. Unveraendert uebernommen. */
        CONSTRUCTION_RECIPES.add(new AnvilConstructionRecipe(
                new AStack[] {
                        new ComparableStack(NtmItems.PLATE_STEEL.get(), 4),
                        new ComparableStack(Items.IRON_INGOT, 12),
                        new ComparableStack(NtmItems.INGOT_COPPER.get(), 2),
                        new ComparableStack(NtmItems.CIRCUIT_VACUUM_TUBE.get(), 2),
                        new ComparableStack(NtmItems.SAWBLADE.get(), 1)
                },
                new AnvilOutput(new ItemStack(NtmBlocks.MACHINE_AUTOSAW.asItem()))
        ).setTier(2).setOverlay(OverlayType.CONSTRUCTION));

        // Runde 8: Drescher und Saegewerk, beide Stufe 2 wie im Original.
        CONSTRUCTION_RECIPES.add(new AnvilConstructionRecipe(
                new AStack[] {
                        new ComparableStack(NtmItems.PLATE_STEEL.get(), 8),
                        new ComparableStack(Items.IRON_INGOT, 12),
                        new ComparableStack(NtmItems.INGOT_COPPER.get(), 2),
                        new ComparableStack(NtmItems.CIRCUIT_VACUUM_TUBE.get(), 1)
                },
                new AnvilOutput(new ItemStack(NtmBlocks.MACHINE_THRESHER.asItem()))
        ).setTier(2).setOverlay(OverlayType.CONSTRUCTION));
        ...
        CONSTRUCTION_RECIPES.add(new AnvilConstructionRecipe(
                ...
                new AnvilOutput(new ItemStack(NtmBlocks.MACHINE_SAWMILL.asItem()))
        ).setTier(2).setOverlay(OverlayType.CONSTRUCTION));

        // Original AnvilRecipes.java Z. 476-491: grosser Mast und Umspannwerk werden
        // ausschliesslich am Amboss gebaut, es gibt fuer beide kein Werkbankrezept.
        CONSTRUCTION_RECIPES.add(new AnvilConstructionRecipe(
                new AStack[] {
                        new RecipesCommon.TagStack(ItemTags.create(ResourceLocation.fromNamespaceAndPath("ntm", "any_concrete")), 2),
                        new ComparableStack(NtmBlocks.STEEL_SCAFFOLD.asItem(), 8),
                        new ComparableStack(NtmItems.PLATE_POLYMER.get(), 8),
                        new ComparableStack(NtmItems.COIL_COPPER.get(), 4)
                },
                new AnvilOutput(new ItemStack(NtmBlocks.RED_PYLON_LARGE.asItem()))
        ).setTier(2).setOverlay(OverlayType.CONSTRUCTION));

        CONSTRUCTION_RECIPES.add(new AnvilConstructionRecipe(
                new AStack[] {
                        new RecipesCommon.TagStack(ItemTags.create(ResourceLocation.fromNamespaceAndPath("ntm", "any_concrete")), 8),
                        new ComparableStack(NtmItems.INGOT_STEEL.get(), 8),
                        new ComparableStack(NtmItems.PLATE_POLYMER.get(), 12),
                        new ComparableStack(NtmItems.COIL_COPPER.get(), 8)
                },
                new AnvilOutput(new ItemStack(NtmBlocks.SUBSTATION.asItem(), 2))
        ).setTier(2).setOverlay(OverlayType.CONSTRUCTION));
