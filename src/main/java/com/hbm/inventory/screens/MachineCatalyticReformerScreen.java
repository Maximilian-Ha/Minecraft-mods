...
/**
 * Portiert aus 1.7.10: com.hbm.inventory.gui.GUIMachineCatalyticReformer.
...
public class MachineCatalyticReformerScreen extends InfoScreen<MachineCatalyticReformerMenu> {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawElectricityInfo(guiGraphics, mouseX, mouseY, this.leftPos + 17, this.topPos + 18, 16, 52,
                this.be.power, MachineCatalyticReformerBlockEntity.MAX_POWER);
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
        ...
        int p = (int) (this.be.power * 52 / Math.max(MachineCatalyticReformerBlockEntity.MAX_POWER, 1L));
