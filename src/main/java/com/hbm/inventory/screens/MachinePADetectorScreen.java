...
public class MachinePADetectorScreen extends InfoScreen<MachinePADetectorMenu> {
    ...
    private static final ResourceLocation TEXTURE = NuclearTechMod.withDefaultNamespace("textures/gui/particleaccelerator/gui_detector.png");

    private final MachinePADetectorBlockEntity be;

    public MachinePADetectorScreen(MachinePADetectorMenu menu, Inventory inv, Component title) {
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        guiGraphics.drawString(this.font, this.title, this.imageWidth / 2 - this.font.width(this.title) / 2 - 8, 5, 0xffffff, false);
