...
/**
 * Portiert aus 1.7.10: com.hbm.inventory.gui.GUIBarrel -- der Big-Ass Tank benutzt dort
 * die Oberflaeche des Fasses mit, nur unter eigenem Namen.
 */
public class MachineBigAssTankScreen extends InfoScreen<MachineBigAssTankMenu> {

    private static final ResourceLocation TEXTURE = NuclearTechMod.withDefaultNamespace("textures/gui/storage/gui_tank.png");

    private final MachineBigAssTankBlockEntity be;

    public MachineBigAssTankScreen(MachineBigAssTankMenu menu, Inventory inventory, Component title) {
