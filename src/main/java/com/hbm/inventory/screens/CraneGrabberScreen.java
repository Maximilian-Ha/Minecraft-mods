...
/**
 * Portiert aus 1.7.10: com.hbm.inventory.gui.GUICraneGrabber.
 * Alle Blit-Koordinaten sind unveraendert uebernommen.
 */
public class CraneGrabberScreen extends FilterScreen<CraneGrabberMenu> {

    private static final ResourceLocation TEXTURE = NuclearTechMod.withDefaultNamespace("textures/gui/storage/gui_crane_grabber.png");
    ...
    protected void renderOwnTooltips(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        if(this.isHovered(mouseX, mouseY, 97, 30, 14, 26)) {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
        ...
        if(this.menu.be.isWhitelist) {
            guiGraphics.blit(TEXTURE, this.leftPos + 108, this.topPos + 33, 176, 0, 3, 6, 256, 256);
        } else {
            guiGraphics.blit(TEXTURE, this.leftPos + 108, this.topPos + 47, 176, 0, 3, 6, 256, 256);
        }
    }
}
