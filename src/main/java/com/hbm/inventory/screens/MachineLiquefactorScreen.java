...
/**
 * Portiert aus 1.7.10: com.hbm.inventory.gui.GUILiquefactor.
 * Alle Blit- und Trefferkoordinaten sind unveraendert uebernommen.
 */
public class MachineLiquefactorScreen extends InfoScreen<MachineLiquefactorMenu> {

    private static final ResourceLocation TEXTURE = NuclearTechMod.withDefaultNamespace("textures/gui/processing/gui_liquefactor.png");

    private final MachineLiquefactorBlockEntity be;

    public MachineLiquefactorScreen(MachineLiquefactorMenu menu, Inventory inventory, Component title) {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        this.be.tank.renderTankTooltip(guiGraphics, mouseX, mouseY, this.leftPos + 71, this.topPos + 36, 16, 52);
        this.drawElectricityInfo(guiGraphics, mouseX, mouseY, this.leftPos + 134, this.topPos + 18, 16, 52,
                this.be.power, MachineLiquefactorBlockEntity.MAX_POWER);
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
        ...
        int p = (int) (this.be.power * 52 / Math.max(MachineLiquefactorBlockEntity.MAX_POWER, 1L));
        ...
        this.be.tank.renderTank(this.leftPos + 71, this.topPos + 88, 0, 16, 52);
    }
}
