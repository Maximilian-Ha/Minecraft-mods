...
public class NtmLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        /* Die Erfolge, Runde 247. Titel und Beschreibungen woertlich aus dem Original;
         * die Wurzel hatte dort keinen eigenen Text -- "Nuclear Tech" ist der Name der
         * AchievementPage, unter der alle einundsechzig hingen. */
        this.add("advancements.hbmsntm.root.title", "Nuclear Tech");
        this.add("advancements.hbmsntm.root.description", "The factory must grow.");
        this.add("advancements.hbmsntm.burner_press.title", "Under Pressure");
        this.add("advancements.hbmsntm.burner_press.description", "Pressure pushing down on me, on you");
        this.add("advancements.hbmsntm.blast_furnace.title", "Coal and Iron");
        this.add("advancements.hbmsntm.blast_furnace.description", "They salvaged a sunken dreadnought for Explorer 1.");
        this.add("advancements.hbmsntm.assembly.title", "The Factory Grows");
        this.add("advancements.hbmsntm.assembly.description", "Wait, it's already 1 am?");
        this.add("advancements.hbmsntm.selenium.title", "XVIII The Moon");
        this.add("advancements.hbmsntm.selenium.description", "Yeah.");
        this.add("advancements.hbmsntm.chemplant.title", "The Factory Grows Pt. 2");
        this.add("advancements.hbmsntm.chemplant.description", "Now you're thinking with chemicals!");
        this.add("advancements.hbmsntm.concrete.title", "Old Reliable");
        this.add("advancements.hbmsntm.concrete.description", "A Bolshevik's favorite.");
        this.add("advancements.hbmsntm.polymer.title", "Teflon");
        this.add("advancements.hbmsntm.polymer.description", "Delicious, delicious microplastics.");
        this.add("advancements.hbmsntm.desh.title", "Le Verrier");
        this.add("advancements.hbmsntm.desh.description", "\"Come on then, you lot. Places to go!\"");
        this.add("advancements.hbmsntm.tantalum.title", "\"Tantalium\"");
        this.add("advancements.hbmsntm.tantalum.description", "An elusive, yet ever-needed element.");
        this.add("advancements.hbmsntm.gas_cent.title", "The Zippe Style");
        this.add("advancements.hbmsntm.gas_cent.description", "Unenriched Uranium hates him!");
        this.add("advancements.hbmsntm.schrab.title", "Island of Stability");
        ...
        this.add("advancements.hbmsntm.rbmk.description", "He's delusional, get him to the infirmary.");
        this.add("advancements.hbmsntm.bismuth.title", "Bismuth");
        this.add("advancements.hbmsntm.bismuth.description", "Remember when people complained about this for a month? I do.");
        this.add("advancements.hbmsntm.breeding.title", "Ironic");
        this.add("advancements.hbmsntm.breeding.description", "Thank you, god bless you, and god bless the United States of America.");
        this.add("advancements.hbmsntm.fusion.title", "Fusion");
        ...
        this.add("advancements.hbmsntm.digamma_see.title", "ENTER THE ABYSS");
        this.add("advancements.hbmsntm.digamma_see.description", "It's a bit dark, bring a flashlight.");
        this.add("advancements.hbmsntm.digamma_feel.title", "SEWAGE-INFUSED GARBAGE WORLD");
        this.add("advancements.hbmsntm.digamma_feel.description", "My eyes are bleeding");
        this.add("advancements.hbmsntm.digamma_know.title", "THE TERROR OF KNOWING");
        this.add("advancements.hbmsntm.digamma_know.description", "what this world is about.");
        this.add("advancements.hbmsntm.inferno.title", "Operation Cannibal");
        this.add("advancements.hbmsntm.inferno.description", "\"Turn it to ashes! That's not enough! Drop more bombs!\"");
        this.add("advancements.hbmsntm.chicago_pile.title", "The navigator landed in the New World");
        this.add("advancements.hbmsntm.chicago_pile.description", "\"How were the natives?\" / \"Very friendly.\"");
        this.add("advancements.hbmsntm.taste_of_blood.title", "The Taste of Blood");
        this.add("advancements.hbmsntm.taste_of_blood.description", "is not part of any testing protocol.");
        this.add("advancements.hbmsntm.c20_5.title", "Chapter [TWENTY POINT FIVE]");
        this.add("advancements.hbmsntm.c20_5.description", "???");
        ...
        this.add(NtmItems.GUN_LASRIFLE, "Laser Rifle");
        this.add(NtmItems.GUN_CHEMTHROWER, "Chemthrower");
        this.add(NtmItems.GUN_FLAMER, "Flamethrower");
        this.add(NtmItems.GUN_FLAMER_TOPAZ, "Mister Topaz");
        this.add(NtmItems.GUN_FLAMER_DAYBREAKER, "Daybreaker");
        this.add(NtmItems.GUN_HENRY_LINCOLN, "Lincoln's Repeater");
        ...
        this.add(NtmItems.GUN_COILGUN, "Coilgun");
        this.add(NtmItems.GUN_TAU, "Tau Cannon");
        this.add(NtmItems.GUN_FATMAN, "Fat Man");
        ...
        this.add(NtmBlocks.DOOR_RED, "Red Door");
        ...
        this.addDamage("broadcast", "%1$s got their brain melted.");
        ...
        this.addDamage("boat", "%1$s was hit by a boat");
        this.addDamagePlayer("boat", "%1$s was hit by a boat thrown by %2$s");
        ...
        this.add(NtmItems.STEEL_HELMET, "Steel Helmet");
        this.add(NtmItems.STEEL_PLATE, "Steel Chestplate");
        this.add(NtmItems.STEEL_LEGS, "Steel Leggings");
        this.add(NtmItems.STEEL_BOOTS, "Steel Boots");
        this.add(NtmItems.TITANIUM_HELMET, "Titanium Helmet");
        this.add(NtmItems.TITANIUM_PLATE, "Titanium Chestplate");
        this.add(NtmItems.TITANIUM_LEGS, "Titanium Leggings");
        this.add(NtmItems.TITANIUM_BOOTS, "Titanium Boots");
        this.add(NtmItems.ALLOY_HELMET, "Advanced Alloy Helmet");
        this.add(NtmItems.ALLOY_PLATE, "Advanced Alloy Chestplate");
        this.add(NtmItems.ALLOY_LEGS, "Advanced Alloy Leggings");
        this.add(NtmItems.ALLOY_BOOTS, "Advanced Alloy Boots");
        this.add(NtmItems.COBALT_HELMET, "Cobalt Helmet");
        this.add(NtmItems.COBALT_PLATE, "Cobalt Chestplate");
        this.add(NtmItems.COBALT_LEGS, "Cobalt Leggings");
        this.add(NtmItems.COBALT_BOOTS, "Cobalt Boots");
        this.add(NtmItems.STARMETAL_HELMET, "Starmetal Helmet");
        this.add(NtmItems.STARMETAL_PLATE, "Starmetal Chestplate");
        this.add(NtmItems.STARMETAL_LEGS, "Starmetal Leggings");
        this.add(NtmItems.STARMETAL_BOOTS, "Starmetal Boots");
        this.add(NtmItems.SECURITY_HELMET, "Security Helmet");
        this.add(NtmItems.SECURITY_PLATE, "Security Chestplate");
        this.add(NtmItems.SECURITY_LEGS, "Security Leggings");
        this.add(NtmItems.SECURITY_BOOTS, "Security Boots");
        this.add(NtmItems.DNT_HELMET, "Dineutronium Helmet");
        this.add(NtmItems.DNT_PLATE, "Dineutronium Chestplate");
        this.add(NtmItems.DNT_LEGS, "Dineutronium Leggings");
        this.add(NtmItems.DNT_BOOTS, "Dineutronium Boots");
        this.add(NtmItems.ROBES_HELMET, "Robes of the Technocrat Helmet");
        this.add(NtmItems.ROBES_PLATE, "Robes of the Technocrat Chestplate");
        this.add(NtmItems.ROBES_LEGS, "Robes of the Technocrat Leggings");
        this.add(NtmItems.ROBES_BOOTS, "Robes of the Technocrat Boots");
        this.add(NtmItems.ZIRCONIUM_LEGS, "Zirconium Leggings");
        this.add(NtmItems.ASBESTOS_HELMET, "Asbestos Helmet");
        this.add(NtmItems.ASBESTOS_PLATE, "Asbestos Chestplate");
        this.add(NtmItems.ASBESTOS_LEGS, "Asbestos Leggings");
        this.add(NtmItems.ASBESTOS_BOOTS, "Asbestos Boots");
        this.add(NtmItems.CMB_HELMET, "Combine Steel Helmet");
        this.add(NtmItems.CMB_PLATE, "Combine Steel Chestplate");
        this.add(NtmItems.CMB_LEGS, "Combine Steel Leggings");
        this.add(NtmItems.CMB_BOOTS, "Combine Steel Boots");
        this.add(NtmItems.SCHRABIDIUM_HELMET, "Schrabidium Helmet");
        this.add(NtmItems.SCHRABIDIUM_PLATE, "Schrabidium Chestplate");
        this.add(NtmItems.SCHRABIDIUM_LEGS, "Schrabidium Leggings");
        this.add(NtmItems.SCHRABIDIUM_BOOTS, "Schrabidium Boots");
        this.add(NtmItems.PAA_PLATE, "PAA Chestplate");
        this.add(NtmItems.PAA_LEGS, "PAA Leggings");
        this.add(NtmItems.PAA_BOOTS, "PAA Boots");
        this.add(NtmItems.T51_HELMET, "T-51b Power Armor Helmet");
        this.add(NtmItems.T51_PLATE, "T-51b Power Armor Chestplate");
        this.add(NtmItems.T51_LEGS, "T-51b Power Armor Leggings");
        this.add(NtmItems.T51_BOOTS, "T-51b Power Armor Boots");

        this.add(NtmItems.EUPHEMIUM_HELMET, "Euphemium Helmet");
        this.add(NtmItems.EUPHEMIUM_PLATE, "Euphemium Chestplate");
        ...
        this.add(NtmItems.TAURUN_HELMET, "Taurun Helmet");
        ...
        this.add(NtmItems.ENVSUIT_HELMET, "M1TTY Environment Suit Helmet");
        ...
        this.add(NtmItems.NOSSY_HAT, "Fabulous Hat");
