...
public class NtmItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        this.basicItem(NtmItems.GLYPHID_MEAT_GRILLED.get());
        ...
        this.basicItem(NtmItems.STICK_C4.get());
        ...
        this.basicItem(NtmItems.STEAMSUIT_HELMET.get());
        ...
        this.basicItem(NtmItems.NOSSY_HAT.get());
        ...
        this.basicItem(NtmItems.STICK_DYNAMITE.get());
        this.basicItem(NtmItems.STICK_DYNAMITE_FISHING.get());
        this.basicItem(NtmItems.CLAY_TABLET.get());
        ...
        this.basicItem(NtmItems.AUSTRALIUM_III.get());
        ...
        this.basicItem(NtmItems.SHIMMER_HANDLE.get());
        this.basicItem(NtmItems.SHIMMER_HEAD.get());
        this.basicItem(NtmItems.SHIMMER_AXE_HEAD.get());
        this.basicItem(NtmItems.SHIMMER_SLEDGE.get());
        this.basicItem(NtmItems.SHIMMER_AXE.get());
        this.basicItem(NtmItems.JACKT.get());
        this.basicItem(NtmItems.JACKT2.get());
        ...
        this.basicItem(NtmItems.COIN_RADIATION.get());
        this.basicItem(NtmItems.COIN_UFO.get());
