...
public class NtmBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.dropSelf(NtmBlocks.WAND_LOGIC.get());
        ...
        this.dropSelf(NtmBlocks.SOYUZ_CAPSULE.get());
        this.dropSelf(NtmBlocks.CRATE_DESH.get());
        this.dropSelf(NtmBlocks.CRATE_TEMPLATE.get());
        this.dropSelf(NtmBlocks.CRATE_LEAD.get());
        this.dropSelf(NtmBlocks.CRATE_METAL.get());
        this.dropSelf(NtmBlocks.CRATE_RED.get());
        ...
        this.dropSelf(NtmBlocks.STEEL_ROOF.get());
        ...
        this.dropSelf(NtmBlocks.PLANT_DEAD_BIGFLOWER.get());
        this.dropSelf(NtmBlocks.PLANT_DEAD_FERN.get());
        ...
        this.dropOther(NtmBlocks.NTM_DIRT.get(), Blocks.DIRT);
        ...
        this.dropSelf(NtmBlocks.BROADCASTER_PC.get());
        this.dropSelf(NtmBlocks.LAMP_DEMON.get());
        this.dropSelf(NtmBlocks.RADIO_TORCH_COUNTER.get());
        ...
        this.dropSelf(NtmBlocks.MACHINE_DEUTERIUM_EXTRACTOR.get());
        this.dropSelf(NtmBlocks.MACHINE_DEUTERIUM_TOWER.get());
        this.dropSelf(NtmBlocks.MACHINE_REFUELER.get());
