...
public class NtmBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        this.directionalBlock(NtmBlocks.RADIO_TORCH_COUNTER.get(), this.models()
                .cubeAll("radio_torch_counter", modLoc("block/rtty_counter")));
        this.blockItem(NtmBlocks.RADIO_TORCH_COUNTER);

        this.directionalBlock(NtmBlocks.RADIO_TORCH_READER.get(), this.models()
        ...
        this.simpleBlockWithItem(NtmBlocks.MACHINE_DEUTERIUM_EXTRACTOR.get(), this.models()
                .cubeBottomTop("machine_deuterium_extractor", modLoc("block/deuterium_extractor_side"),
                        modLoc("block/deuterium_extractor_top_water"), modLoc("block/deuterium_extractor_top_water")));
        this.particleOnlyBlock(NtmBlocks.MACHINE_VACUUM_DISTILL, modLoc("block/block_steel"));
        this.particleOnlyBlock(NtmBlocks.MACHINE_SOLIDIFIER, modLoc("block/block_steel"));
        this.particleOnlyBlock(NtmBlocks.MACHINE_PYRO_OVEN, modLoc("block/block_steel"));
        this.particleOnlyBlock(NtmBlocks.MACHINE_LIQUEFACTOR, modLoc("block/block_steel"));
        this.particleOnlyBlock(NtmBlocks.MACHINE_GAS_FLARE, modLoc("block/block_steel"));
        this.particleOnlyBlock(NtmBlocks.MACHINE_COKER, modLoc("block/block_steel"));
        this.particleOnlyBlock(NtmBlocks.MACHINE_CATALYTIC_CRACKER, modLoc("block/block_steel"));
        ...
        this.particleOnlyBlock(NtmBlocks.MACHINE_TOWER_SMALL, modLoc("block/block_steel"));
        this.particleOnlyBlock(NtmBlocks.MACHINE_TOWER_LARGE, modLoc("block/block_steel"));
    ...
    private void techneKasten(BlockModelBuilder model, String textur,
                              float x, float y, float z, int b, int h, int tf, int u, int v) {
    ...
    private void registerBroadcasterGehaeuse(Block block, String textur) {
        ...
        this.techneKasten(model, "#all", 11.5F, 13, 7.5F, 1, 11, 1, 0, 18);  // Antenne
