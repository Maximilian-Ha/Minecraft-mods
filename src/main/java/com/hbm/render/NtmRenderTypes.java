...
public class NtmRenderTypes {
    ...
    /**
     * Durchgefaerbte Vierecke ohne Textur und ohne Beleuchtung -- fuer Anzeigen, die aus sich
     * heraus leuchten. Ersetzt das, was das Original mit abgeschalteter Textur und gesetzter
     * Vollhelligkeit von Hand tat.
     *
     * Bausteine allesamt dieselben wie bei GLOW, nur deckend statt additiv und mit Tiefenschreiben.
     */
    public static final RenderType SOLID_COLOR = RenderType.create(
            "solid_color",
            DefaultVertexFormat.POSITION_COLOR,
            Mode.QUADS,
            1536,
