...
public class RenderChungus extends BlockEntityRendererNT<ChungusBlockEntity> implements IBEWLRProvider {
    ...
    /*
     * Das Modell ist fuenfzehn Bloecke lang und der Kern sitzt an einem Ende. Vorlage: INFINITE_EXTENT_AABB.
     *
     ...
     */
    @Override
    public boolean shouldRenderOffScreen(ChungusBlockEntity be) {
        return true;
    }
