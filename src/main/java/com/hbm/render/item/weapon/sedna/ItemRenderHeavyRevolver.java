...
/**
 * Portiert aus 1.7.10: com.hbm.render.item.weapon.sedna.ItemRenderHeavyRevolver.
 *
 * Der Zeichner des schweren Revolvers. Die Debugwaffe benutzt dasselbe Modell (lilmac.obj)
 * mit einer anderen Textur und erbt deshalb hiervon -- im Original ist es genauso: ein
 * Zeichner, dem die Textur hereingereicht wird.
 *
 * ABWEICHUNG: das Original zeichnet auf Wunsch noch ein Zielfernrohr ("Scope") und weitet
 * dafuer das Blickfeld. Den Aufsatz gibt es im Port nicht, also auch das nicht.
 */
