...
public class NtmBlockEntityTypes {
    ...
    public static final Supplier<BlockEntityType<MachineSILEXBlockEntity>> MACHINE_SILEX = BLOCK_ENTITY_TYPES.register("machine_silex", () -> BlockEntityType.Builder.of(MachineSILEXBlockEntity::new, NtmBlocks.MACHINE_SILEX.get()).build(null));
    public static final Supplier<BlockEntityType<MachineFELBlockEntity>> MACHINE_FEL = BLOCK_ENTITY_TYPES.register("machine_fel", () -> BlockEntityType.Builder.of(MachineFELBlockEntity::new, NtmBlocks.MACHINE_FEL.get()).build(null));
    ...
    public static final Supplier<BlockEntityType<RadioTorchLogicBlockEntity>> RADIO_TORCH_LOGIC = BLOCK_ENTITY_TYPES.register("radio_torch_logic", () -> BlockEntityType.Builder.of(RadioTorchLogicBlockEntity::new, NtmBlocks.RADIO_TORCH_LOGIC.get()).build(null));
    ...
    public static final Supplier<BlockEntityType<DeuteriumExtractorBlockEntity>> MACHINE_DEUTERIUM_EXTRACTOR = BLOCK_ENTITY_TYPES.register("machine_deuterium_extractor", () -> BlockEntityType.Builder.of(DeuteriumExtractorBlockEntity::new, NtmBlocks.MACHINE_DEUTERIUM_EXTRACTOR.get()).build(null));
    public static final Supplier<BlockEntityType<DeuteriumTowerBlockEntity>> MACHINE_DEUTERIUM_TOWER = BLOCK_ENTITY_TYPES.register("machine_deuterium_tower", () -> BlockEntityType.Builder.of(DeuteriumTowerBlockEntity::new, NtmBlocks.MACHINE_DEUTERIUM_TOWER.get()).build(null));
    public static final Supplier<BlockEntityType<RefuelerBlockEntity>> MACHINE_REFUELER = BLOCK_ENTITY_TYPES.register("machine_refueler", () -> BlockEntityType.Builder.of(RefuelerBlockEntity::new, NtmBlocks.MACHINE_REFUELER.get()).build(null));
    ...
    public static final Supplier<BlockEntityType<FoundryBasinBlockEntity>> FOUNDRY_BASIN = BLOCK_ENTITY_TYPES.register(
            ...
            () -> BlockEntityType.Builder.of(
                    ...
                    .build(null));
    public static final Supplier<BlockEntityType<FoundryOutletBlockEntity>> FOUNDRY_OUTLET = BLOCK_ENTITY_TYPES.register(
            "foundry_outlet",
            () -> BlockEntityType.Builder.of(
    ...
    public static final Supplier<BlockEntityType<WandLogicBlockEntity>> WAND_LOGIC = BLOCK_ENTITY_TYPES.register(
            "wand_logic",
            () -> BlockEntityType.Builder.of(
                            WandLogicBlockEntity::new,
                            NtmBlocks.WAND_LOGIC.get())
                    .build(null));
    ...
    public static final Supplier<BlockEntityType<ChargeBlockEntity>> CHARGE = BLOCK_ENTITY_TYPES.register("charge", () -> BlockEntityType.Builder.of(ChargeBlockEntity::new, NtmBlocks.CHARGE_DYNAMITE.get(), NtmBlocks.CHARGE_MINER.get(), NtmBlocks.CHARGE_C4.get(), NtmBlocks.CHARGE_SEMTEX.get()).build(null));
