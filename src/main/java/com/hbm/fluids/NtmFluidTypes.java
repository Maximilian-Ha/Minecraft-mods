...
public class NtmFluidTypes {
    ...
    /**
     * Corium fliesst zaeher und kaelter als Lava -- es ist keine Gesteinsschmelze, sondern
     * geschmolzener Kern. Die Bewegung im Fluid uebernimmt der Standard; das Original hatte hier
     * ohnehin nichts Eigenes.
     */
    public static final DeferredHolder<FluidType, FluidType> CORIUM_TYPE = FLUID_TYPES.register(
            "corium_fluid",
            () -> new FluidType(FluidType.Properties.create()
                    .canSwim(false)
                    .canDrown(false)
    ...
    /**
     * Rotschlamm -- der Rueckstand der Watz-Reaktion. Dick, heiss und giftig.
     *
     * Die Zahlen stehen so im Original (MudFluid): Dichte 2500, Zaehigkeit 3000, Leuchtkraft 5,
     * Temperatur 2773. Die Temperatur ist absurd hoch fuer etwas, das aussieht wie Schlamm, aber
     * sie ist dort so gesetzt, und sie aendert im Spiel nichts ausser der Anzeige.
     */
    public static final DeferredHolder<FluidType, FluidType> MUD_TYPE = FLUID_TYPES.register(
            "mud_fluid",
            () -> new FluidType(FluidType.Properties.create()
                    .canSwim(false)
                    .canDrown(false)
