 ...
 *
 * WAS NOCH FEHLT, und zwar aus dem Vorrat des Originals, nicht aus Nachlaessigkeit: sechs
 * Eintraege haengen an Gegenstaenden, die der Port noch nicht hat.
 *
 *   Nachschub: definitelyfood, pill_iodine, canister_full (Diesel), med_bag
 *   Waffen:    gun_henry, gun_n_i_4_n_i
 *
 * Die uebrigen Eintraege stehen mit den Gewichten des Originals da. Kommen die sechs nach,
 * gehoeren sie mit ihren Gewichten hierher -- sie sind oben namentlich aufgefuehrt, damit
 * niemand nachschlagen muss.
 *
 * NACHGETRAGEN: radaway. Es stand hier als siebter fehlender Eintrag; der Gegenstand gibt es
 * jetzt, und damit steht er mit dem Gewicht des Originals drin.
 */
