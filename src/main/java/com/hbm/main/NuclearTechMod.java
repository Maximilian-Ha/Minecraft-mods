...
import com.hbm.fluids.NtmFluidBridge;
...
import com.hbm.lib.NtmCapabilities;
...
public class NuclearTechMod {
    ...
    public NuclearTechMod(IEventBus eventBus, ModContainer container) {
        ...
        // Nach Fluids.init(), sonst ist die Fluidliste noch leer.
        NtmFluidBridge.register(eventBus);
