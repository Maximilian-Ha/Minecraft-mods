...
public class ResourceManager {
    ...
    public static final ResourceLocation TAU_TEX = NuclearTechMod.withDefaultNamespace("textures/models/weapon/tau.png");
    ...
    /* Der Fau-Anzug hat fuenf Texturen, eine mehr als die anderen: die Kassette. */
    public static final ResourceLocation FAU_HELMET = NuclearTechMod.withDefaultNamespace("textures/armor/fau_helmet.png");
    public static final ResourceLocation FAU_CHEST = NuclearTechMod.withDefaultNamespace("textures/armor/fau_chest.png");
    public static final ResourceLocation FAU_ARM = NuclearTechMod.withDefaultNamespace("textures/armor/fau_arm.png");
    ...
    /* Der Umgebungsanzug: vier Texturen. Die fuenfte des Originals (envsuit_tail) bindet
     * dort niemand, deshalb gibt es sie hier nicht. */
    public static final ResourceLocation ENVSUIT_HELMET = NuclearTechMod.withDefaultNamespace("textures/armor/envsuit_helmet.png");
    public static final ResourceLocation ENVSUIT_CHEST = NuclearTechMod.withDefaultNamespace("textures/armor/envsuit_chest.png");
    public static final ResourceLocation ENVSUIT_ARM = NuclearTechMod.withDefaultNamespace("textures/armor/envsuit_arm.png");
    public static final ResourceLocation ENVSUIT_LEG = NuclearTechMod.withDefaultNamespace("textures/armor/envsuit_leg.png");

    /* Der Blackjack-Anzug. Der "Helm" ist eine Augenklappe, daher der abweichende Name. */
    public static final ResourceLocation BJ_EYEPATCH = NuclearTechMod.withDefaultNamespace("textures/armor/bj_eyepatch.png");
    public static final ResourceLocation BJ_CHEST = NuclearTechMod.withDefaultNamespace("textures/armor/bj_chest.png");
    public static final ResourceLocation BJ_ARM = NuclearTechMod.withDefaultNamespace("textures/armor/bj_arm.png");
    ...
    /* Der Dieselanzug. Modell und Texturen heissen bnuuy, die Gegenstaende dieselsuit_* --
     * dritter Name fuer dieselbe Sache, siehe ModelArmorDiesel. */
    public static final ResourceLocation DIESELSUIT_HELMET = NuclearTechMod.withDefaultNamespace("textures/armor/bnuuy_helmet.png");
    public static final ResourceLocation DIESELSUIT_CHEST = NuclearTechMod.withDefaultNamespace("textures/armor/bnuuy_chest.png");
    public static final ResourceLocation DIESELSUIT_ARM = NuclearTechMod.withDefaultNamespace("textures/armor/bnuuy_arm.png");
    public static final ResourceLocation DIESELSUIT_LEG = NuclearTechMod.withDefaultNamespace("textures/armor/bnuuy_leg.png");
    ...
    public static IModelCustom tau;
    ...
    public static IModelCustom armor_dieselsuit;
    ...
    public static void init() {
        ...
        tau = new HFRWavefrontObject("models/obj/weapons/tau.obj").asVBO();
        ...
        armor_dieselsuit = new HFRWavefrontObject("models/obj/armor/bnuuy.obj").asVBO();
