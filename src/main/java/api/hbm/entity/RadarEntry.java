...
public class RadarEntry {
    ...
    public void decode(RegistryFriendlyByteBuf buf) {
        /* Der Name wurde hier bis Runde 126 zwar GELESEN, aber nicht zugewiesen -- der Puffer
         * stand danach richtig, das Feld blieb null. Aufgefallen ist es erst mit dem Radarschirm,
         * der die Eintraege weiterreicht; im Original steht die Zuweisung da. */
