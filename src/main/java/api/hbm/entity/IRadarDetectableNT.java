...
public interface IRadarDetectableNT {
    ...
    int TIER3 =		3;
    int TIER4 =		4;
    /* Runde 132 hat diese fuenf gebraucht (die Eigenbau-Rakete meldet ihre Groesse ans Radar),
     * sie standen aber noch auskommentiert da. Die Blip-Textur hat ihre Zeilen laengst -- sonst
     * saessen TIER_AB bis SPECIAL an der falschen Stelle. */
    int TIER10 =	5;
    int TIER10_15 =	6;
    int TIER15 =	7;
    int TIER15_20 =	8;
